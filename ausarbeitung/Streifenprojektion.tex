...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Ergebnisse nach diff- und free-Linienerkennung}
	\label{fig:blue_0}
\end{figure}
...
\begin{table}[H]
	\begin{tabular}{c|c|c}
		...
		\begin{tabular}{c|c|c}
			Anzahl & Avg (mm) & Stdabw (mm) \\ \hline
			19048 & 224.166 & 8.76011 \\
			8321 & 338.722 & 14.8228 \\
			4294 & 460.079 & 14.5428 \\
			3063 & 587.986 & 11.6962 \\
		\end{tabular} & 
		\begin{tabular}{c|c|c}
			Anzahl & Avg (mm) & Stdabw (mm) \\ \hline
			5733 & 225.367 & 1.08721 \\
			3535 & 340.892 & 2.82819 \\
			1475 & 461.271 & 3.90112 \\
			1156 & 586.405 & 7.37468 \\
		\end{tabular}
	\end{tabular}
