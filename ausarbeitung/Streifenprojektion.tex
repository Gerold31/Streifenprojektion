...
\begin{figure}[H]
	...
	\begin{tabular}{l|l|l|l}
		...
		\hline 
		& & \\
		\raisebox{0.75em}{\includegraphics[height=6em]{includes/red_0.png}} & 
		\raisebox{0.75em}{\includegraphics[height=6em]{includes/red_0_diff.png}} &
		\raisebox{0.75em}{\includegraphics[height=6em]{includes/red_0_free.png}} &
		\raisebox{0.75em}{\includegraphics[height=6em]{includes/red_0_peak.png}} \\
		\hline
		& & \\
