...
Zusätzlich fällt auf, dass die durchschnittliche Entfernung von sowohl diff als auch free 38mm - 41mm ($12,5\%-13,5\%$) größer ist als erwartet (300~mm), siehe dazu Abschnitt \ref{sec:dists}.
...
\begin{figure}[H]
	...
	\begin{tabular}{c|c|c|c}
		& Deckenlampe & Schreibtischlampe & beide Lampen \\
		\hline
		 & & & \\
