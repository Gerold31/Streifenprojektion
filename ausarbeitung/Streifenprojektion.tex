...
Wir steuern mit Hilfe eines Mikrocontrollers einen Linienlaser an, mit dem wir eine Linie in die Szene projizieren.
Mit einer Webcam nehmen wir die Szene auf und geben die Aufnahmen an die Verarbeitungssoftware weiter.
Für diese wurde drei Verfahren zur Linienerkennung implementiert und deren Leistung ausgewertet.
...
Alles in allem lässt sich aus den Tests entnehmen, dass die Diff-Linienerkennung robuster gegen Farbvariationen als Free oder Peak.

Zusammenfassend kann man sagen, dass unsere Umsetzung der Messmethode Streifenlichtprojektion für die investierten Ressourcen gute Ergebnisse liefert und dabei mit günstigem Equipment auskommt.
