...
\begin{frame}
	...
	\hfill
	\only<1>{\includegraphics[width=0.9\linewidth]{includes/cap.png}}
	\only<2>{\includegraphics[width=0.9\linewidth]{includes/line.png}}
	\only<3>{\includegraphics[width=0.9\linewidth]{includes/3d.png}}
	\only<4>{\includegraphics[width=0.9\linewidth]{includes/3d_2.png}}
	\only<5>{\includegraphics[width=0.9\linewidth]{includes/3d_3.png}}
	\only<6>{\includegraphics[width=0.9\linewidth]{includes/3d_4.png}}
	\hfill
...
\begin{frame}
	\frametitlesec
	\framesubtitles{Organsiatorisches}
