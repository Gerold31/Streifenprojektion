...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Stereo-Vision?\\
		{\color{HUblue}Benötigt eindeutig wiedererkennbare Muster!}
		\item Structure from Motion?\\
		{\color{HUblue}s. Stereo-Vision!}
		\item Time of Flight?\\
		{\color{HUblue}Geringe Auflösung!\\
...
\begin{frame}
	...
	\textbf{Variante 1}\\
	Einfache Linienerkennung durch Differenzbildung (diff):
	\vfill
	\begin{columns}
...
\begin{frame}
	...
	\textbf{Variante 2}\\
	Linienerkennung durch kanalweise Mittelwertbildung und logische Verknüpfung (free):
	\vfill
	\begin{columns}
...
\begin{frame}
	\frametitlesec
	\framesubtitles{Verschiedene Entfernungen - Entfernung}
...
\begin{frame}
	\frametitlesec
	\framesubtitles{Verschiedene Entfernungen - Höhe}
